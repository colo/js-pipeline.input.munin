...
var debug = require('debug')('js-pipeline.input.Munin');
var debug_events = require('debug')('js-pipeline.input.Munin:Events');
var debug_internals = require('debug')('js-pipeline.input.Munin:Internals');
